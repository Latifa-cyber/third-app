...
class ResultViva extends StatefulWidget {
  ...
  ResultViva({
    required this.prjctName,
    required this.supMark,
    required this.pstMark,
    required this.exmMark,
    required this.vivaMark,
  });

  @override
  State<ResultViva> createState() =>
      _ResultVivaState(prjctName, supMark, pstMark, exmMark, vivaMark);
}
...
class _ResultVivaState extends State<ResultViva> {
  ...
  String vivaMark = '';
  _ResultVivaState(
      this.prjctName, this.supMark, this.pstMark, this.exmMark, this.vivaMark);
